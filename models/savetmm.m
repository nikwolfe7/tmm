...
for i = 1:nmodels
    ...
    fprintf(fid,'%d\n',numTs);
    fprintf(fid,'#\n# eta values for all student-t comopnent densities (nTmm x 1 array)\n');
    fprintf(fid,'%e ',nu);
    fprintf(fid,'\n');
    fprintf(fid,'#\n# mixture weights for all student-t comopnent densities (nTmm x 1 array)\n');
    fprintf(fid,'%e ',mixw);
    fprintf(fid,'\n');
